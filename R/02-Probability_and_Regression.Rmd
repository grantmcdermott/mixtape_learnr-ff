...
This is material for the **Probability and Regression** chapter in Scott Cunningham's book, [Causal Inference: The Mixtape.](https://mixtape.scunning.com/) **GM: This is 
the "fast forward" version, adapted by Grant McDermott.** 
...
a sandboxed project environment. I _strongly_ recommend you follow this method
...
## Some options
theme_set(theme_minimal()) # Cleaner ggplot2 theme
options(datatable.print.class=TRUE, datatable.print.keys=TRUE) # data.table print options
